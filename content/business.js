...
const BUSINESS = [
  ...
  { id:"q_tether", kind:"question",
    text:"Written question, the Liberal benches: the cost of the International concession to date." },
  ...
  { id:"q_anchor", kind:"question",
    text:"Oral question, One-G: the indemnity under the anchor concession if the International fails." },
  ...
  { id:"c_anchor", kind:"committee",
    ...
    text:"The Committee on Trade and the Anchors reports on the renewed International terms." },
